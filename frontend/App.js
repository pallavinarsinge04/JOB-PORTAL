...
function Home() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 dark:text-white">
      ...
      <nav className="bg-blue-600 dark:bg-black text-white p-4 flex justify-between items-center shadow">
        ...
        <div className="space-x-3">
          ...
          <Link to="/register">
            ...
            <button className="bg-black text-white border px-4 py-2 rounded font-semibold">
      ...
      {/* Search */}
      <div className="p-10 bg-gray-200 dark:bg-gray-800">
      ...
      <div className="p-10">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {filteredJobs.map((job) => (
            ...
            <div
              key={job._id}
              className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow hover:shadow-2xl transition"
            >
              ...
              <button
                ...
                className="mt-4 mr-3 bg-blue-600 text-white px-4 py-2 rounded"
              >
    ...
    <BrowserRouter>
      ...
      <div className="fixed bottom-5 right-5 z-50">
        ...
        <button
          ...
          className="bg-gray-800 text-white px-5 py-3 rounded-full shadow-lg"
        >
